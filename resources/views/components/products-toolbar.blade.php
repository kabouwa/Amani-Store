            ...
            <form action="{{ route('admin.products.index') }}" method="GET">
                ...
                <div class="space-y-1.5 mb-5">
                    ...
                    <label class="flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                        ...
                        <i class="fa-solid fa-calendar-plus text-gray-400 dark:text-gray-500 w-4 text-xs"></i>
                        <span class="text-sm text-gray-700 dark:text-gray-200">Date d'ajout</span>
                    </label>

                    <label class="flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                        <input type="radio" name="sort" value="purchase_price" class="accent-amani"
                            {{ request('sort') === 'purchase_price' ? 'checked' : '' }}>
                        <i class="fa-solid fa-money-bill-wave text-gray-400 dark:text-gray-500 w-4 text-xs"></i>
                        <span class="text-sm text-gray-700 dark:text-gray-200">Prix d'achat</span>
                    </label>

                    <label class="flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                        <input type="radio" name="sort" value="selling_price" class="accent-amani"
                            {{ request('sort') === 'selling_price' ? 'checked' : '' }}>
                        <i class="fa-solid fa-tag text-gray-400 dark:text-gray-500 w-4 text-xs"></i>
                        <span class="text-sm text-gray-700 dark:text-gray-200">Prix de vente</span>
                    </label>

                    <label class="flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                        <input type="radio" name="sort" value="title" class="accent-amani"
                            {{ request('sort') === 'title' ? 'checked' : '' }}>
                        <i class="fa-solid fa-font text-gray-400 dark:text-gray-500 w-4 text-xs"></i>
                        <span class="text-sm text-gray-700 dark:text-gray-200">Titre</span>
                    </label>
    ...
    <div id="filterPanel"
        ...
        <form action="{{ route('admin.products.index') }}" method="GET">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {{-- Stock min --}}
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Stock min</label>
                    <div class="relative">
                ...
                {{-- Stock max --}}
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Stock max</label>
                    <div class="relative">
